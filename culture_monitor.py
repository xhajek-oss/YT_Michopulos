...
for _ in range(12):
    ...
    if (
        ...
        # Pokud už jsme narazili na element,
        # který obsahuje jen jeden event,
        # dále ho nerozšiřujeme.
...
# DŮLEŽITÉ:
# Ticketportal používá odkazy /Event/...
# ale parser nesmí být závislý na velikosti písmen.
links = soup.find_all(
    "a",
    href=lambda href: (
        href
